...
class oxcWindowMenuItem:
    ...
    def on_menuitem_tools_cad_activate(self, widget, data=None):
        ...
        """
        self.tunnel[self.selected_ref].send_data("\xfe\x01\x00\x00\x00\x00\x00\x1d")
        self.tunnel[self.selected_ref].send_data("\xfe\x01\x00\x00\x00\x00\x00\x38")
        self.tunnel[self.selected_ref].send_data("\xfe\x01\x00\x00\x00\x00\x00\xd3")
        self.tunnel[self.selected_ref].send_data("\xfe\x00\x00\x00\x00\x00\x00\x1d")
        self.tunnel[self.selected_ref].send_data("\xfe\x00\x00\x00\x00\x00\x00\x38")
        self.tunnel[self.selected_ref].send_data("\xfe\x00\x00\x00\x00\x00\x00\xd3")
